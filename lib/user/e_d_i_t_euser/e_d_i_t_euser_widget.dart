...
import 'e_d_i_t_euser_model.dart';
export 'e_d_i_t_euser_model.dart';
                ...
                children: [
                          ...
                          children: [
                            Padding(
                              ...
                              child: TextFormField(
                                controller: _model.nicknameController ??=
                                  ...
                                  text: columnUserRecord.nickname,
                                ),
                                autofocus: true,
                                obscureText: false,
                            ...
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  8.0, 0.0, 8.0, 0.0),
                              child: TextFormField(
                                controller: _model.realnameController ??=
                                    TextEditingController(
                                  text: columnUserRecord.realName,
                                ),
                                autofocus: true,
                                obscureText: false,
                                decoration: InputDecoration(
                                ...
                                style: FlutterFlowTheme.of(context).bodyMedium,
                                validator: _model.realnameControllerValidator
                                    .asValidator(context),
                              ),
                            ),
                          ],
                  ...
                  wrapWithModel(
                    ...
                    child: CountryPickerWidget(
                      selectedCountryName: columnUserRecord.countryName,
                      selectedCountryFlag: columnUserRecord.countryFlag,
                    ),
                  ),
                  Row(
                    mainAxisSize: MainAxisSize.max,
                  ...
                  StreamBuilder<TeamRecord>(
                    stream: TeamRecord.getDocument(
                        columnUserRecord.memberOfTeamPATH!),
                    builder: (context, snapshot) {
                      // Customize what your widget looks like when it's loading.
                      if (!snapshot.hasData) {
                        return Center(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                await currentUserReference!
                                  ...
                                  avatar: _model
                                      .imageUploaderModel.uploadedImagePath,
                                  nickname: _model.nicknameController.text,
                                  realName: _model.realnameController.text,
                                  countryFlag: _model
                                      .countryPickerModel.selectedCountryFlag,
                                  countryName: _model
                                      .countryPickerModel.selectedCountryName,
                                ));
                              },
                              text: 'Сохранить',
                              options: FFButtonOptions(
