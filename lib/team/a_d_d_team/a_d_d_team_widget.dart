                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: FFButtonWidget(
                        onPressed: () async {
                          await TeamRecord.collection.doc().set({
                            ...createTeamRecordData(
                              logotype:
                                  _model.imageUploaderModel.uploadedImagePath,
                              name: _model.textController1.text,
                              tag: _model.textController2.text,
                              countryFlag:
                                  _model.countryPickerModel.selectedCountryFlag,
                              countryName:
                                  _model.countryPickerModel.selectedCountryName,
                              owner: currentUserReference,
                            ),
                            'members': [currentUserReference],
                          });
                          _model.getOwnerData = await queryTeamRecordOnce(
                          ...
                          await _model.getOwnerData!.owner!
                              .update(createUserRecordData(
                            ownerOfTeamPATH: _model.getOwnerData?.reference,
                            memberOfTeamPATH: _model.getOwnerData?.reference,
                            memberOfTeamNAME: _model.getOwnerData?.name,
                            memberOfTeamTAG: _model.getOwnerData?.tag,
                            memberOfTeamTeamRole: 'Основатель',
                            memberOfTeamLineUp: false,
                            alreadyCreatTeam: true,
                          ));
                          context.safePop();
