...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'TeamVeiew',
          path: '/teamVeiew',
          builder: (context, params) => TeamVeiewWidget(
            teamReference: params.getParam(
                'teamReference', ParamType.DocumentReference, false, ['team']),
          ),
        ),
        FFRoute(
          name: 'Teams',
        ...
        FFRoute(
          ...
          builder: (context, params) => VIEWuserWidget(
            userReference: params.getParam(
                'userReference', ParamType.DocumentReference, false, ['user']),
          ),
        ),
        FFRoute(
          name: 'EDITEuser',
        ...
        FFRoute(
          name: 'ADD_tournament',
          path: '/aDDTournament',
          builder: (context, params) => ADDTournamentWidget(),
        ),
        FFRoute(
          name: 'LIST_tournaments',
          path: '/lISTTournaments',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'LIST_tournaments')
              : LISTTournamentsWidget(),
        ),
        FFRoute(
          name: 'EDITE_tournament',
          path: '/eDITETournament',
          builder: (context, params) => EDITETournamentWidget(
            tournamentReference: params.getParam('tournamentReference',
                ParamType.DocumentReference, false, ['tournament']),
          ),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          path: '/aDDMatch',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'ADD_match')
              : ADDMatchWidget(),
        ),
        FFRoute(
          name: 'matches',
        ...
        FFRoute(
          name: 'EDITE_match',
          path: '/eDITEMatch',
          builder: (context, params) => EDITEMatchWidget(
            matchReference: params.getParam('matchReference',
                ParamType.DocumentReference, false, ['match']),
          ),
        )
