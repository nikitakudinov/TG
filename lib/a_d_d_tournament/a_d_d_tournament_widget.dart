...
import 'a_d_d_tournament_model.dart';
export 'a_d_d_tournament_model.dart';
                  ...
                  Expanded(
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        _model.tournamentData = await queryTournamentRecordOnce(
                        ...
                        await currentUserReference!.update({
                          'OwnerOfTournamentPath': FieldValue.arrayUnion(
